    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String city = mCitiesSpinner.getSelectedItem().toString();
                String house = mHouseNumberSpinner.getSelectedItem().toString();

                Toast.makeText(MainActivity.this, String.format("Адрес: %s, %s, %s", country, city, house), Toast.LENGTH_LONG).show();
            }
        });
